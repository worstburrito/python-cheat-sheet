...
filenames = ['alice.txt', 'siddhartha.txt', 'moby_dick.txt',
             'little_women.txt', 'missing_file.txt']
...
# Creates a new document with a .json file format
path = Path('numbers.json')
contents = json.dumps(numbers)
path.write_text(contents)

# Reads the list back into memory
...
# Greeting the user we've stored when they come back
# We would not ask them their name again, but
# The rest of the program works the same here.
print(f"Welcome back, {username}!")

# Combining the last two programs into if/else
from pathlib import Path
import json
